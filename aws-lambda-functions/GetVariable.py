...
# this is exposed at https://taadt2w2i0.execute-api.us-east-1.amazonaws.com/prod/GetVariable using an AWS API Gateway trigger
...
def lambda_handler(event, context):
    ...
    return variables.get_item(Key={"variable": event["variable"]})["Item"]